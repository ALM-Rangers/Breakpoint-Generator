...
using ALMRangers.TracepointGenerator;
using Microsoft.VsSDK.UnitTestLibrary;
using Microsoft.VisualStudio.Shell.Interop;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using Microsoft.VisualStudio.Shell;
using ALMRangers.TracepointGeneratorPackage;

namespace TracepointGenerator.Package_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TracepointGeneratorPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(ALMRangers.TracepointGeneratorPackage.GuidList.guidTracepointGenerator_PackageCmdSet, (int)ALMRangers.TracepointGeneratorPackage.PkgCmdIDList.cmdidTracepointGenerator);
