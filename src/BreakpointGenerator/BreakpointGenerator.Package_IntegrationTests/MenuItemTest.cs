...
namespace TracepointGenerator.Package_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(ALMRangers.TracepointGeneratorPackage.GuidList.guidTracepointGenerator_PackageCmdSet, (int)ALMRangers.TracepointGeneratorPackage.PkgCmdIDList.cmdidTracepointGenerator);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Tracepoint Generator", "ALMRangers.TracepointGenerator_Package.TracepointGeneratorPackage");
